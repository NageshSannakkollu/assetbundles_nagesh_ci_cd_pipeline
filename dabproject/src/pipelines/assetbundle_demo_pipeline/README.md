# assetbundle_demo_pipeline

This folder defines all source code for the 'assetbundle_demo_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_assetbundle_demo_pipeline.py" to get familiar with the syntax.
